...
export const toolQualityMetadata = Object.freeze({
  ...
  create_webhook: metadata(
    ...
    "Requires Webex write access, causes Webex to send future requests to the configured target, is non-idempotent, and returns the webhook record or an error result without automatically retrying rate limits.",
  ),
