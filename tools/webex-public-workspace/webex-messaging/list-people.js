...
/**
 * Function to list people in an organization using the Webex Messaging API.
 *
...
/**
 * Tool configuration for listing people in an organization using the Webex Messaging API.
 * @type {Object}
 */
const apiTool = {
